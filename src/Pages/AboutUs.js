  ...
  return (
    <div>
      <div className="mt-[7%] abt bg-cover md:text-2xl text-[#e1e1e1] px-5 md:px-14">
        ...
        <p
          data-aos="flip-up"
          className="text-[#dacb31] md:text-5xl font-semibold md:py-7 py-5 text-2xl"
        >
          About Us
        </p>

        <p data-aos="fade-right" className=" md:mt-5 mt-2">
        ...
        <p data-aos="fade-ight" className=" mt-2">
        ...
        <p data-aos="fade-right" className=" mt-2 pb-7">
