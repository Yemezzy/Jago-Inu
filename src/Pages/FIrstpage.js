  ...
  return (
    <div className="">
      <div className="pb-3 md:px-3 h-[80%] first-page border-white border-b-4">
        ...
        <div className="md:h-[200px] hidden md:block h-[150px] sho  p-5">
          <div className="flex justify-between">
            ...
            <section
              data-aos="flip-up"
              className="ml-7 flex gap-5 text-lg font-semibold items-center text-[#dacb31] md:mt-[15%]  text-center  border-white"
            >
              <a href="">Home</a>
              <a href="">About</a>
              <a href="">Tokenomics</a>
      ...
      <div className="md:mt-14 py-14 vvv md:p-14 bbn text-xl text-[#e1e1e1]">
        <p
          data-aos="zoom-out"
          className="md:text-5xl text-2xl font-bold text-center mt-10"
        >
      ...
      <div className="text-right px-14">
        <div
          data-aos="flip-up"
          className="flex gap-5 justify-center  pb-5 text-[#dacb31] "
        >
          <a href="">
